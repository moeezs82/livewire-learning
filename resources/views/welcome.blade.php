            ...
            <header class="flex bg-white justify-between h-20 border-b border-b-gray-200 items-center px-6">
                <div id="left-header" class="">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a wire:navigate href="/" class="nav-link active" aria-current="page">Home</a></li>
                        <li class="nav-item"><a wire:navigate href="/about" class="nav-link">ABout</a></li>
                        <li class="nav-item"><a wire:navigate href="/contact" class="nav-link">Contact</a></li>
                    </ul>
                </div>
